...
const Banner = ({query, handleInputChange}) => {
  ...
  return (
    <div className='max-w-screen-2x1 container mx-auto xl:px-24 px-4 md:py-20 py-14'>
      <h1 className='text-4xl font-bold text-primary mb-3'>Find your <span className='text-blue'>next step</span> in Tech today</h1>
      <p className='text-lg text-black/70 mb-8'>Navigate in the tech job market with confidence and ease</p>
